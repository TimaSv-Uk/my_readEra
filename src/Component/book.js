...
//         "doc_sha1": "842c0a4485103e4f65642b2cc679fc5eb52a05a8",
//         "doc_active": 1,
//         "doc_format": "EPUB",
...
//     "links": []
// }
export default function renderBook(json_book) {
  let bookDiv = document.createElement("div");
  bookDiv.id = json_book["uri"];
  let book_style = `
      background: #C1C13F;
  `;
  if (json_book["data"]["doc_favorites_time"] > 0) {
    bookDiv.style = `
  ...
  bookDiv.textContent = `${json_book["data"]["doc_title"]} -- ${json_book["data"]["doc_have_read_time"]}`;
  return bookDiv;
}
